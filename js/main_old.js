/* Галерея квартир */
// При добавлении новой квартиры нужно скопировать один кейс и заменить номер ID  #case на 7,8,,9  и т.д


$('#flat1 .flat-thumbs').delegate('img','click', function(){
    $('#flat1 .img-large').attr('src',$(this).attr('src').replace('small','large'));
});

$('#flat2 .flat-thumbs').delegate('img','click', function(){
    $('#flat2 .img-large').attr('src',$(this).attr('src').replace('small','large'));
});

$('#flat3 .flat-thumbs').delegate('img','click', function(){
    $('#flat3 .img-large').attr('src',$(this).attr('src').replace('small','large'));
});

$('#flat4 .flat-thumbs').delegate('img','click', function(){
    $('#flat4 .img-large').attr('src',$(this).attr('src').replace('small','large'));
});

$('#flat5 .flat-thumbs').delegate('img','click', function(){
    $('#flat5 .img-large').attr('src',$(this).attr('src').replace('small','large'));
});
